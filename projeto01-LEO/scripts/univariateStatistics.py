...
def timeSeriesDecompose(aqTableAlvo,pol,uf,repoPath,stationAlvo):
    ...
    aqTableAlvo_reset = aqTableAlvo[[pol]].reset_index()
    dataDecompose = aqTableAlvo_reset[[pol,'datetime']]
    ...
    fig.savefig(repoPath+'/figures/'+uf+'/decompose_'+pol+'_'+stationAlvo+'.png')
